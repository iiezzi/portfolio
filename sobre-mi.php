        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5 col-12 mt-4">
                    ...
                    <p class="pb-sm-5">Estudiante de programación web.</p>
                    <a href="contacto.html" class="btn btn-rojo">Enviar mensaje</a>
                </div>
                <div class="col-sm-3 col-12 mt-4 offset-sm-2">
                    <img src="images/Iñaki-Iezzi.jpg" alt="Iñaki Iezzi" title="Iñaki Iezzi" class="img-fluid img-circle">
                </div>
            </div>
        </div>
        <section id="stack-tecno" class="color-gradiente pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="my-sm-5 text-white">Stack de tecnologías</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-2 col-6 text-center">
                        <div class="px-4 py-5 cajas mx-0 mb-4 mb-sm-0">
                            <h3>Javascript</h3>
        ...
        <section id="formacion-academica" class="container">
                ...
                <div class="col-12 col-sm-6">
                    <div class="row">
                        <div class="col-2 py-3 my-auto d-none d-sm-block">
                            <img src="images/vector-escuela.jpg" class="img-fluid" title="vector-colegio">
                        </div>
                        <div class="col-12- col-sm-10 p-3">
                            <h3 class="izquierda">Secundario Completo</h3>
                            <h4>Colegio del Libertador</h4>
                            <h5>2013 – 2018</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="row shadow bg-white rounded p-1">
                <div class="col-12 col-sm-6">
                    <div class="row">
                        <div class="col-2 py-3 my-auto d-none d-sm-block">
                            <img src="images/logo-dpcsuite.jpg" class="img-fluid" title="depcsuite">
                        </div>
                        <div class="col-12- col-sm-10 p-3">
                            <h3 class="izquierda">Desarrollador Full Stack</h3>
                            <h4>DePCSuite</h4>
                            <h5>2022</h5>
